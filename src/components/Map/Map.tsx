...
async function initializeMap() {
  ...
  Object.keys(countries).forEach((countryIsoKey) => {
    ...
    const countryGeoObject = new ymaps.GeoObject(country, {
      ...
      fillColor: isVisitedRegionOrCountry(countryIsoKey) ? '#80ff80' : '#e2e2e2',
      strokeWidth: 0,
      strokeColor: '#db757f',
  ...
  Object.keys(regions).forEach((regionIsoCode) => {
    ...
    const regionGeoObject = new ymaps.GeoObject(region, {
      fillOpacity: 0.5,
      fillColor: isVisitedRegionOrCountry(regionIsoCode) ? '#80ff80' : '#e2e2e2',
      strokeWidth: 0,
      strokeColor: '#db757f',
    });
